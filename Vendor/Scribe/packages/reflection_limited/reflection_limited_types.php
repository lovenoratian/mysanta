...
$GLOBALS['E_TTypeTag'] = array('T_VOID' => 1, 'T_BOOL' => 2, 'T_BYTE' => 3, 'T_I16' => 6, 'T_I32' => 8, 'T_I64' => 10, 'T_DOUBLE' => 4, 'T_STRING' => 11, 'T_STRUCT' => 12, 'T_MAP' => 13, 'T_SET' => 14, 'T_LIST' => 15, 'T_ENUM' => 101, 'T_NOT_REFLECTED' => 102);
...
final class TTypeTag {
    ...
    public static $__names = array(1 => 'T_VOID', 2 => 'T_BOOL', 3 => 'T_BYTE', 6 => 'T_I16', 8 => 'T_I32', 10 => 'T_I64', 4 => 'T_DOUBLE', 11 => 'T_STRING', 12 => 'T_STRUCT', 13 => 'T_MAP', 14 => 'T_SET', 15 => 'T_LIST', 101 => 'T_ENUM', 102 => 'T_NOT_REFLECTED');
}
...
class SimpleType {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'ttype', 'type' => TType::I32), 2 => array('var' => 'name', 'type' => TType::STRING));
        }
        if (is_array($vals)) {
            if (isset($vals['ttype'])) {
...
class ContainerType {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'ttype', 'type' => TType::I32), 2 => array('var' => 'subtype1', 'type' => TType::STRUCT, 'class' => 'SimpleType'), 3 => array('var' => 'subtype2', 'type' => TType::STRUCT, 'class' => 'SimpleType'));
        }
        if (is_array($vals)) {
            if (isset($vals['ttype'])) {
                $this->ttype = $vals['ttype'];
...
class ThriftType {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'is_container', 'type' => TType::BOOL), 2 => array('var' => 'simple_type', 'type' => TType::STRUCT, 'class' => 'SimpleType'), 3 => array('var' => 'container_type', 'type' => TType::STRUCT, 'class' => 'ContainerType'));
        }
        if (is_array($vals)) {
...
class Argument {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'key', 'type' => TType::I16), 2 => array('var' => 'name', 'type' => TType::STRING), 3 => array('var' => 'type', 'type' => TType::STRUCT, 'class' => 'ThriftType'));
        }
        if (is_array($vals)) {
            if (isset($vals['key'])) {
                $this->key = $vals['key'];
...
class Method {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'name', 'type' => TType::STRING), 2 => array('var' => 'return_type', 'type' => TType::STRUCT, 'class' => 'ThriftType'), 3 => array('var' => 'arguments', 'type' => TType::LST, 'etype' => TType::STRUCT, 'elem' => array('type' => TType::STRUCT, 'class' => 'Argument')));
        }
        if (is_array($vals)) {
            if (isset($vals['name'])) {
                $this->name = $vals['name'];
...
class Service {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'name', 'type' => TType::STRING), 2 => array('var' => 'methods', 'type' => TType::LST, 'etype' => TType::STRUCT, 'elem' => array('type' => TType::STRUCT, 'class' => 'Method')), 3 => array('var' => 'fully_reflected', 'type' => TType::BOOL));
        }
        if (is_array($vals)) {
            if (isset($vals['name'])) {
                $this->name = $vals['name'];
