...
include_once THRIFT_ROOT . '/packages/scribe/scribe_types.php';
include_once THRIFT_ROOT . '/packages/fb303/FacebookService.php';
...
class scribe_Log_args {
    ...
    public function __construct($vals = null) {
        if (!isset(self::$_TSPEC)) {
            self::$_TSPEC = array(1 => array('var' => 'messages', 'type' => TType::LST, 'etype' => TType::STRUCT, 'elem' => array('type' => TType::STRUCT, 'class' => 'LogEntry')));
        }
        if (is_array($vals)) {
